...
with st.expander("How to use this App"):
    ...
    st.write("Note: If the app provides a nil return, try to hit submit again or re-select a differnt option. You may need to rerun the app. We seek your patience as it's only a prototype.")
